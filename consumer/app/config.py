...
HTTP_MAX_CONNECTIONS = get_env_int("HTTP_MAX_CONNECTIONS", 200)
HTTP_MAX_KEEPALIVE_CONNECTIONS = get_env_int("HTTP_MAX_KEEPALIVE_CONNECTIONS", 30)
HTTP_CONNECT_TIMEOUT = get_env_int("HTTP_CONNECT_TIMEOUT", 10)
HTTP_READ_TIMEOUT = get_env_int("HTTP_READ_TIMEOUT", 30)
HTTP_WRITE_TIMEOUT = get_env_int("HTTP_WRITE_TIMEOUT", 10)
HTTP_POOL_TIMEOUT = get_env_int("HTTP_POOL_TIMEOUT", 30)
